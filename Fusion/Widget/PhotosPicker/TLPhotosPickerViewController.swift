...
public struct TLPhotosPickerConfigure {
    public var defaultCameraRollTitle = "相机胶卷"
    public var tapHereToChange = "Tap here to change"
    public var cancelTitle = "取消"
    public var doneTitle = "确定"
...
//        self.cancelButton.title = self.configure.cancelTitle
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: self.configure.doneTitle, style: .plain, target: self, action: #selector(doneButtonTap))
        self.navigationItem.leftBarButtonItem = UIBarButtonItem(title: self.configure.cancelTitle, style: .plain, target: self, action: #selector(cancelButtonTap))
...
//        self.subTitleArrowImageView.image = TLBundle.podBundleImage(named: "arrow")
        ...
        // add
        self.navigationItem.title = self.configure.defaultCameraRollTitle
